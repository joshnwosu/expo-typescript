...
const ColorIcon: React.FC<Props> = ({
  ...
  <Svg viewBox="0 0 24 24" width={24} height={24} fill="none" {...props}>
    <Path
      fill={fill}
      d="M8 22.75c-3.72 0-6.75-3.03-6.75-6.75 0-3.04 2.04-5.72 4.97-6.51.37-.1.75.09.89.45.61 1.53 1.91 2.7 3.5 3.13.88.24 1.9.24 2.76 0 .37-.1.76.09.9.45.31.79.47 1.63.47 2.49 0 1.92-.82 3.75-2.25 5.02A6.708 6.708 0 0 1 8 22.75ZM6.02 11.13c-1.95.8-3.27 2.72-3.27 4.87 0 2.89 2.36 5.25 5.25 5.25 1.3 0 2.54-.48 3.5-1.35a5.196 5.196 0 0 0 1.75-3.9c0-.46-.06-.9-.17-1.33-.94.15-1.96.1-2.86-.15a6.816 6.816 0 0 1-4.2-3.39Z"
    />
    <Path
      fill={fill}
